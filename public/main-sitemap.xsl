			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Reveal</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Reveal</title>
					</xsl:otherwise>
				</xsl:choose>
					...
					<xsl:when test="kml:kml">
						...
						<div id="description">
							...
							<h1>KML File</h1>
															...
															<p>
									This KML File provides location information to Google.								</p>
					...
					<xsl:otherwise>
						...
						<div id="description">
							...
							<h1>XML Sitemap</h1>
															...
															<p>
									This XML Sitemap is what search engines like Google use to crawl and re-crawl posts, pages, and other content on this website.								</p>
